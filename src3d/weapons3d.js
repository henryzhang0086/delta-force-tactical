...
(function (DF, D3) {
  ...
  var EXTRA = {
    ...
    awm:   { id:'awm',   name:'AWM 狙击步枪',  category:'sniper',  damage:400,mag:5,  reserve:25,  rpm:36,  auto:false, reload:3.6, spread:0.0016,range:2600,velocity:2900, desc:'顶级栓狙，命中即一枪毙命（穿满甲秒杀）' },
    ...
    scar:  { id:'scar',  name:'M7 战斗步枪',   category:'ar',     damage:55, mag:20, reserve:120, rpm:750, auto:true,  reload:2.4, spread:0.028, range:760, velocity:1600, desc:'7.62 重弹，高射速大伤害战斗步枪' },
