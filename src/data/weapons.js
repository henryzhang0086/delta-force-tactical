...
(function (DF) {
  ...
  DF.WEAPONS = {
    ...
    // —— 主武器：精确射手步枪 ——
    m14:    { id:'m14',    name:'M14 射手步枪',    category:'marksman',damage:52,mag:50,reserve:150,rpm:440,auto:true,  reload:2.8, spread:0.013, range:900, velocity:1900, scope:'reddot', ads:46, desc:'50 发大容量全自动射手步枪，红点速瞄，中近距离火力压制' },
